    ...
    public static class WebHelper
    {
        ...
        public static string ResolveUrl(string relativeUrl)
        {
            ...
            if (relativeUrl.Contains("://"))
                return relativeUrl;
            return DirFileHelper.MapPath(relativeUrl);// VirtualPathUtility.ToAbsolute(relativeUrl);
        ...
        public static void WriteSession<T>(string key, T value)
        {
            ...
            //Session.Set<T>(HttpContext.Current.Session, key, value);
            HttpContext.Current.Session.Set(key, ByteConvertHelper.Object2Bytes(value));
        ...
        public static string GetSession(string key)
        {
            ...
            byte[] value = null;
            HttpContext.Current.Session.TryGetValue(key, out value);
            return ByteConvertHelper.Bytes2Object<string>(value);
        ...
        {
            string value = "";
            if (!HttpContext.Current.Request.Cookies.TryGetValue(strName, out value))
            {
                HttpContext.Current.Request.HttpContext.Response.Cookies.Append(strName, strValue);
            }
            else
            {
                if (string.IsNullOrEmpty(value))
                {
                    HttpContext.Current.Request.HttpContext.Response.Cookies.Delete(strName);
                    HttpContext.Current.Request.HttpContext.Response.Cookies.Append(strName, strValue);
                }
            }
        ...
        public static void WriteCookie(string strName, string strValue, int expires)
        {
            ...
            DateTime dateTime = DateTime.Now.AddMinutes(expires.ToDouble());
            option.Expires = new DateTimeOffset(dateTime);

            string value = "";
            if (!HttpContext.Current.Request.Cookies.TryGetValue(strName, out value))
            {
                HttpContext.Current.Request.HttpContext.Response.Cookies.Append(strName, strValue, option);
            }
            else
            {
                if (string.IsNullOrEmpty(value))
        ...
        {
            string value = "";
            HttpContext.Current.Request.Cookies.TryGetValue(strName, out value);
        ...
        {
            HttpContext.Current.Request.HttpContext.Response.Cookies.Delete(CookiesName);
        }
        #endregion
        ...
        public static List<IFormFile> GetFileControls()
        {
            ...
            var files = HttpContext.Current.Request.Form.Files;
            if (files.Count == 0)
                return result;
        ...
        /// 注意:Form标记必须加入属性 enctype="multipart/form-data",服务器端才能获取客户端file控件.
        /// </summary>
        public static IFormFile GetFileControl()
        {
